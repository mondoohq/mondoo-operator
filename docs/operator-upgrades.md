...
In case you are running a Mondoo Operator with a version older than v1 in your cluster, it is required to perform extra steps before upgrading. Before applying the `v1.0.0` manifests run:
```bash
