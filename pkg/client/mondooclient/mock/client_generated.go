...
// RefreshAssetScores mocks base method.
func (m *MockMondooClient) RefreshAssetScores(arg0 context.Context, arg1 *mondooclient.RefreshAssetScoresRequest) (*mondooclient.RefreshAssetScoresResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RefreshAssetScores", arg0, arg1)
	ret0, _ := ret[0].(*mondooclient.RefreshAssetScoresResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RefreshAssetScores indicates an expected call of RefreshAssetScores.
func (mr *MockMondooClientMockRecorder) RefreshAssetScores(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RefreshAssetScores", reflect.TypeOf((*MockMondooClient)(nil).RefreshAssetScores), arg0, arg1)
}
