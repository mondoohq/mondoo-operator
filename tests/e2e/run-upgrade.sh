...
#
# Usage:
#   ./run-upgrade.sh <cloud> <baseline-version>
#   ./run-upgrade.sh gke 12.0.1

set -euo pipefail

CLOUD="${1:?Usage: $0 <cloud> <baseline-version>}"
export CLOUD_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/${CLOUD}" && pwd)"
source "${CLOUD_DIR}/../scripts/common.sh"

export BASELINE_VERSION="${2:?Usage: $0 <cloud> <baseline-version>}"

info "=========================================="
info "  Test: Upgrade (${CLOUD}, baseline: v${BASELINE_VERSION})"
info "=========================================="
...
info ""
info "=========================================="
info "  Test: Upgrade (${CLOUD}) - COMPLETE"
info "=========================================="
