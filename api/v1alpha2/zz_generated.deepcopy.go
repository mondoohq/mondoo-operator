...
func (in *Containers) DeepCopyInto(out *Containers) {
	*out = *in
	...
	in.RuntimeCache.DeepCopyInto(&out.RuntimeCache)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeScannerSet) DeepCopyInto(out *NodeScannerSet) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
	if in.NodeSelector != nil {
		in, out := &in.NodeSelector, &out.NodeSelector
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeScannerSet.
func (in *NodeScannerSet) DeepCopy() *NodeScannerSet {
	if in == nil {
		return nil
	}
	out := new(NodeScannerSet)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Nodes) DeepCopyInto(out *Nodes) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
	if in.ScannerSets != nil {
		in, out := &in.ScannerSets, &out.ScannerSets
		*out = make([]NodeScannerSet, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeCacheDelegate) DeepCopyInto(out *RuntimeCacheDelegate) {
	*out = *in
	...
	if in.Snapshotters != nil {
		in, out := &in.Snapshotters, &out.Snapshotters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ReadOnly != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeCacheDelegate.
func (in *RuntimeCacheDelegate) DeepCopy() *RuntimeCacheDelegate {
	if in == nil {
		return nil
	}
	out := new(RuntimeCacheDelegate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RuntimeCacheScanner) DeepCopyInto(out *RuntimeCacheScanner) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
	if in.ScannerSets != nil {
		in, out := &in.ScannerSets, &out.ScannerSets
	...
	if in.ScanOnlyInUse != nil {
		in, out := &in.ScanOnlyInUse, &out.ScanOnlyInUse
		*out = new(bool)
		**out = **in
	}
	if in.TempStorageSize != nil {
		in, out := &in.TempStorageSize, &out.TempStorageSize
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.Delegates != nil {
		in, out := &in.Delegates, &out.Delegates
		*out = make([]RuntimeCacheDelegate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RuntimeCacheScanner.
func (in *RuntimeCacheScanner) DeepCopy() *RuntimeCacheScanner {
	if in == nil {
		return nil
	}
	out := new(RuntimeCacheScanner)
	in.DeepCopyInto(out)
	return out
}
