...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeScanProfile) DeepCopyInto(out *NodeScanProfile) {
	*out = *in
	if in.NodeSelector != nil {
		in, out := &in.NodeSelector, &out.NodeSelector
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeScanProfile.
func (in *NodeScanProfile) DeepCopy() *NodeScanProfile {
	if in == nil {
		return nil
	}
	out := new(NodeScanProfile)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Nodes) DeepCopyInto(out *Nodes) {
	*out = *in
	...
	if in.Profiles != nil {
		...
		*out = make([]NodeScanProfile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
