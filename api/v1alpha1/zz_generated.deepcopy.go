...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MondooClientSpec) DeepCopyInto(out *MondooClientSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MondooClientSpec.
func (in *MondooClientSpec) DeepCopy() *MondooClientSpec {
	if in == nil {
		return nil
	}
	out := new(MondooClientSpec)
	in.DeepCopyInto(out)
	return out
}
