...
func (r *StatusReporter) Report(ctx context.Context, m v1alpha2.MondooAuditConfig, cfg v1alpha2.MondooOperatorConfig) error {
	...
	operatorStatus := ReportStatusRequestFromAuditConfig(ctx, integrationMrn, m, nodes.Items, r.k8sVersion, r.containerImageResolver, cfg.Spec.SkipContainerResolution, logger)
	...
	mondooClient, err := r.mondooClientBuilder(mondooclient.MondooClientOptions{
		...
		HttpsProxy:  cfg.Spec.HttpsProxy,
